...
public class TestFruitList {
	...
	public static void main(String[] args) {
		...
		int counter = 0;
		while (flag) {
			System.out.println("Enter a Fruit no. to add in basket as per choice :\n 1. Apple\n 2. Mango\n 3. Orange \n4. To Check the FruitsList"
					+ "\n5. End Of Fruit List");
			switch (sc.nextInt()) {
			case 1:
				if (counter < fruits.length) {
					fruits[counter++] = new FruitList("Apple", "Sweet and Sour in taste");
				} else {
			...
			case 2:
				if (counter < fruits.length) {
					fruits[counter++] = new FruitList("Mango", "Sweet  in taste");
				} else {
					System.out.println("Bag is Full !! can't add Fruit.......");
				}
				break;
			case 3:
				if (counter < fruits.length) {
					fruits[counter++] = new FruitList("Orange", "Sour in taste");
				} else {
					System.out.println("Bag is Full !! can't add Fruit........");
				}
				break;
			case 4:
				for (FruitList p : fruits) {
					System.out.println(p.getName() + "   " + p.getTaste());
				}
				break;
			case 5:
